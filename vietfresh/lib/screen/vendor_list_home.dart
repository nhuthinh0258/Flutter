...
class VendorListHome extends StatelessWidget {
  const VendorListHome(
      {super.key, required this.category, required this.vendorList});
    ...
    return Scaffold(
      ...
      body: ListView.builder(
          ...
          itemBuilder: (ctx, index) {
            ...
            final String? imageVendor = vendor['image'];
            if (imageVendor != null) {
                ...
                child: Stack(
                  ...
                  children: [
                    FadeInImage(
                      ...
                      image: imageProvider, // Đường dẫn đến hình ảnh chính
                      fit: BoxFit
